...
<h6>1. Animal punya method umum speak(). 
  2. Dog dan Bird override speak() → ini polimorfisme runtime.
  3. Data disimpan dalam List<Animal> tetapi objek aktualnya bisa Dog dan Bird.
  4. Saat dilakukan looping: 
